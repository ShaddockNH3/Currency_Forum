...
function __VLS_template() {
    ...
    if (__VLS_ctx.result !== null) {
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({ ...{ class: ("result-text") }, });
        (__VLS_ctx.form.amount);
        (__VLS_ctx.form.fromCurrency);
        __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({ ...{ class: ("result-amount") }, });
        (__VLS_ctx.result);
        // @ts-ignore
    ...
    else if (__VLS_ctx.form.fromCurrency && __VLS_ctx.form.toCurrency && __VLS_ctx.form.amount) {
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("result error") }, });
    ...
    if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
        ...
        __VLS_styleScopedClasses['result-text'];
