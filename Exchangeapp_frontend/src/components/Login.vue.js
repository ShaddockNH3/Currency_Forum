...
const login = async () => {
    try {
        await authStore.login(form.value.loginField, form.value.password);
...
function __VLS_template() {
    ...
    const __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8({ label: ("用户名/邮箱/手机号"), labelWidth: ("140px"), }));
    const __VLS_10 = __VLS_9({ label: ("用户名/邮箱/手机号"), labelWidth: ("140px"), }, ...__VLS_functionalComponentArgsRest(__VLS_9));
    ({}({ label: ("用户名/邮箱/手机号"), labelWidth: ("140px"), }));
    ...
    // @ts-ignore
    [ElInput,];
    const __VLS_15 = __VLS_asFunctionalComponent(__VLS_14, new __VLS_14({ modelValue: ((__VLS_ctx.form.loginField)), placeholder: ("请输入用户名、邮箱或手机号"), }));
    const __VLS_16 = __VLS_15({ modelValue: ((__VLS_ctx.form.loginField)), placeholder: ("请输入用户名、邮箱或手机号"), }, ...__VLS_functionalComponentArgsRest(__VLS_15));
    ({}({ modelValue: ((__VLS_ctx.form.loginField)), placeholder: ("请输入用户名、邮箱或手机号"), }));
    // @ts-ignore
    [form, form, login,];
    ...
    // @ts-ignore
    [ElFormItem, ElFormItem,];
    const __VLS_21 = __VLS_asFunctionalComponent(__VLS_20, new __VLS_20({ label: ("密码"), labelWidth: ("140px"), }));
    const __VLS_22 = __VLS_21({ label: ("密码"), labelWidth: ("140px"), }, ...__VLS_functionalComponentArgsRest(__VLS_21));
    ({}({ label: ("密码"), labelWidth: ("140px"), }));
